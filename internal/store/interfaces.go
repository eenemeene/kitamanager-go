...
type GovernmentFundingBillPeriodStorer interface {
	...
	FindByOrganization(ctx context.Context, orgID uint, search string, dateRange BillPeriodDateRange, limit, offset int) ([]models.GovernmentFundingBillPeriod, int64, error)
	...
	FindBillTotalsByRowTypeAttributed(ctx context.Context, orgID uint, from, to time.Time) (map[time.Time]BillTotalsByRowType, error)
