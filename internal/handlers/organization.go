...
func (h *OrganizationHandler) List(c *gin.Context) {
	...
	c.JSON(http.StatusOK, models.NewPaginatedResponseWithLinks(organizations, params.Page, params.Limit, total, c.Request.URL.Path, c.Request.URL.RawQuery))
}
...
func (h *OrganizationHandler) Create(c *gin.Context) {
	...
	h.auditService.LogResourceCreate(c.Request.Context(), getUserID(c), getUserEmail(c), "organization", organization.ID, organization.Name, c.ClientIP(), &organization.ID)
