...
var registry = map[string]entry{
	...
	"cannot deactivate the last superadmin":                                                 {ID: "user.last_superadmin_deactivate"},
	...
	"only superadmins can delete a superadmin":                                              {ID: "user.superadmin_delete"},
	"only superadmins can modify a superadmin":                                              {ID: "user.superadmin_modify"},
