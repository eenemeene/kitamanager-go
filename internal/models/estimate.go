...
type ChildFundingEstimateRequest struct {
	Birthdate  time.Time          `json:"birthdate" format:"date-time" binding:"required" example:"2022-05-15T00:00:00Z"`
	Date       *time.Time         `json:"date,omitempty" format:"date-time" example:"2026-04-01T00:00:00Z"`
...
type EmployeeCostEstimateResponse struct {
	...
	PayPlanWeeklyHours       float64 `json:"payplan_weekly_hours" example:"39.4"`
