...
export interface components {
  schemas: {
    ...
    FinancialDataPoint: {
      /**
       * @description Actual funding from government funding bills, keyed by the month
       ...
       * @example 100000
       */
      actual_funding_correction_attributed?: number;
      /**
      ...
      /**
       * @description The same amounts keyed by the month each bill row is ABOUT (the
