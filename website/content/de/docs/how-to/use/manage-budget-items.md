...
3. Setzen Sie den **Namen** (z. B. „Miete" oder „Elternbeiträge") und wählen Sie **Einnahme** oder **Ausgabe**.
...
1. Öffnen Sie den Posten aus der Liste.
...
- Beträge sind in Euro, nicht in Cents. KitaManager konvertiert intern zu Cents — siehe [Warum Geldbeträge als Cents gespeichert werden](../../../explanation/why-money-is-stored-as-cents/).
