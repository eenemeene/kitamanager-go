...
You want to print one of the statistics pages (or save it as a PDF) for a board meeting or audit.

## Steps

1. Navigate to the report — Statistics → Staffing Hours, Children Statistics, Occupancy Matrix, Financial Overview, etc.
2. Set any filters (date range, section).
3. Click **Print** at the top of the page.
4. Your browser's print dialog opens. Choose your printer or **Save as PDF**.
